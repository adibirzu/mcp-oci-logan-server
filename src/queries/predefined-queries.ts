...
// ============================================================================
export const VCN_FLOW_QUERIES: PredefinedQuery[] = [
  {
...
// ============================================================================
export const OCI_AUDIT_QUERIES: PredefinedQuery[] = [
  {
...
// ============================================================================
export const DATABASE_QUERIES: PredefinedQuery[] = [
  {
    id: 'db_ora_errors',
...
// ============================================================================
export const API_GATEWAY_QUERIES: PredefinedQuery[] = [
  {
...
// ============================================================================
export const OBJECT_STORAGE_QUERIES: PredefinedQuery[] = [
  {
...
// ============================================================================
export const SECURITY_QUERIES: PredefinedQuery[] = [
  {
...
// ============================================================================
export const COMPUTE_QUERIES: PredefinedQuery[] = [
  {
...
// ============================================================================
export const LOAD_BALANCER_QUERIES: PredefinedQuery[] = [
  {
...
// AGGREGATED EXPORTS
// ============================================================================
export const ALL_PREDEFINED_QUERIES: PredefinedQuery[] = [
  ...VCN_FLOW_QUERIES,
  ...OCI_AUDIT_QUERIES,
  ...DATABASE_QUERIES,
  ...API_GATEWAY_QUERIES,
 ...
 */
export function getQueriesByCategory(categoryId: string): PredefinedQuery[] {
 ...
 * Get queries by tag
 */
export function getQueriesByTag(tag: string): PredefinedQuery[] {
 ...
 */
export function searchQueries(searchTerm: string): PredefinedQuery[] {
  const lower = searchTerm.toLowerCase();
  return ALL_PREDEFINED_QUERIES.filter(q =>
 ...
 */
export function getUntestedQueries(): PredefinedQuery[] {
 ...
 */
export function getQueryStats(): { total: number; tested: number; untested: number; byCategory: Record<string, number> } {
