...
export function buildSecurityTriage(args: Record<string, string>): PromptMessage[] {
...
export function buildThreatHunt(args: Record<string, string>): PromptMessage[] {
...
export function buildIncidentInvestigation(args: Record<string, string>): PromptMessage[] {
...
export function buildComplianceCheck(args: Record<string, string>): PromptMessage[] {
...
export function buildDetectionCoverageGap(args: Record<string, string>): PromptMessage[] {
...
export function buildDailySecurityBrief(args: Record<string, string>): PromptMessage[] {
