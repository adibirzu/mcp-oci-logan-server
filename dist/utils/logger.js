...
function redactSensitive(data, depth = 0) {
    if (!LOG_REDACT_SENSITIVE || depth > 10)
        return data;
...
class Logger {
    ...
    toolCall(toolName, args) {
        this.debug(`Tool call: ${toolName}`, { args: redactSensitive(args) });
    }
    /**
     * Log tool result
     */
    toolResult(toolName, success, executionTimeMs) {
